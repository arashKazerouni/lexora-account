import { uint8ArrayToString, stringToUint8Array, compareUint8Arrays } from 'uint8array-extras';
import { trimEnd } from './util/util.js';
import '../xdr/index.js';
import { Keypair } from './keypair.js';
import { StrKey } from './strkey.js';
import { hash } from './hashing.js';
import { AssetType as AssetType$1 } from '../xdr/generated/asset-type.js';
import { Asset as Asset$1 } from '../xdr/generated/asset.js';
import { ChangeTrustAsset } from '../xdr/generated/change-trust-asset.js';
import { TrustLineAsset } from '../xdr/generated/trust-line-asset.js';
import { HashIdPreimage } from '../xdr/generated/hash-id-preimage.js';
import { HashIdPreimageContractId } from '../xdr/generated/hash-id-preimage-contract-id.js';
import { ContractIdPreimage } from '../xdr/generated/contract-id-preimage.js';
import { AlphaNum4 } from '../xdr/generated/alpha-num4.js';
import { AlphaNum12 } from '../xdr/generated/alpha-num12.js';
...
function asciiCompare(a, b) {
  return compareUint8Arrays(stringToUint8Array(a), stringToUint8Array(b));
}
class Asset {
  /** The asset code. */
  code;
  ...
  static #deriveRawAssetType(code, issuer) {
    if (!issuer) {
      return AssetType$1.assetTypeNative;
    }
    return code.length <= 4 ? AssetType$1.assetTypeCreditAlphanum4 : AssetType$1.assetTypeCreditAlphanum12;
  }
  /**
  ...
  static fromOperation(assetXdr) {
    ...
    switch (assetXdr.type) {
      ...
      case "assetTypeCreditAlphanum12": {
        ...
        asset.#rawAssetType = AssetType$1.assetTypeCreditAlphanum12;
        return asset;
      }
      default:
   ...
   */
  toXdrObject() {
    return this._toXdrObject(Asset$1);
  }
  /**
  ...
  _toXdrObject(xdrAsset) {
    ...
    if (this.getRawAssetType().value === AssetType$1.assetTypeCreditAlphanum4.value) {
      const assetType2 = new AlphaNum4({
  ...
  getAssetType() {
    switch (this.getRawAssetType().value) {
      case AssetType$1.assetTypeNative.value:
        return AssetType.native;
      case AssetType$1.assetTypeCreditAlphanum4.value:
        return AssetType.credit4;
      case AssetType$1.assetTypeCreditAlphanum12.value:
