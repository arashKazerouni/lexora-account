...
${eventMethods}
    ...
    if (events.length > 0) {
      ...
      events.forEach((event) => {
        const topicParams = event.params.filter(
          (param) => param.location.value === scSpecEventParamLocationV0.ScSpecEventParamLocationV0.scSpecEventParamLocationTopicList.value
        );
  ...
  static methodInput(input) {
    return {
      key: utils.propertyKey(input.name.toString()),
