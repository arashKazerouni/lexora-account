...
class Asset {
  ...
  static #deriveRawAssetType(code, issuer) {
    if (!issuer) {
      return assetType.AssetType.assetTypeNative;
    }
    return code.length <= 4 ? assetType.AssetType.assetTypeCreditAlphanum4 : assetType.AssetType.assetTypeCreditAlphanum12;
  }
  /**
  ...
  static fromOperation(assetXdr) {
    ...
    switch (assetXdr.type) {
      ...
      case "assetTypeCreditAlphanum12": {
        ...
        asset.#rawAssetType = assetType.AssetType.assetTypeCreditAlphanum12;
        return asset;
      }
      default:
  ...
  _toXdrObject(xdrAsset) {
    ...
    if (this.getRawAssetType().value === assetType.AssetType.assetTypeCreditAlphanum4.value) {
    ...
    const assetType$1 = new alphaNum12.AlphaNum12({
      assetCode: uint8arrayExtras.stringToUint8Array(this.code.padEnd(12, "\0")),
      issuer: keypair.Keypair.fromPublicKey(this.issuer).xdrAccountId()
    });
    return xdrAsset.assetTypeCreditAlphanum12(assetType$1);
  }
  /**
   ...
   */
  equals(asset) {
    return this.code === asset.getCode() && this.issuer === asset.getIssuer() && this.getRawAssetType().value === asset.getRawAssetType().value;
  }
  /**
